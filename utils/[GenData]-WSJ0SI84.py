...
######### file paths
filelists_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/WSJ0_SI84/filelists/'
train_speech_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/WSJ0_SI84/WSJ0_77spks/'
test_speech_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/WSJ0_SI84/WSJ0_6spks_unseen/'
train_noise_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/Noises/noise_split_100000_h5/'
test_noise_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/Noises/noise_test/'
test_mixture_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/WSJ_TEST_SAMP/'
train_mixture_path = '/mnt/raid/user_space/zhangkanghao/data/ns_data/WSJ_TRAIN_SAMP/'
...
if FLAGS.mode == 'train':
    # sys.exit()
    speech_list = open(filelists_path + 'trainFileList_WSJ0SI84.txt', 'r')
    filelines_speech = speech_list.readlines()
    speech_list.close()
    print('%d sentences in total' % len(filelines_speech))
    cnt = 0
    total_time = 0.
    ...
    speech_list = open(filelists_path + 'testFileList_WSJ0SI84.txt', 'r')
    filelines_speech = speech_list.readlines()
    speech_list.close()
    FLAGS.corpus = 'WSJ'
    f_test_list = open(filelists_path + 'test_list.txt', 'w')
    for noise_name in test_noise_list:
        ...
        for snr in test_snr_list:
            f_test_list.write(
                '{}_{}_snr{}_{}.samp {}\n'.format(FLAGS.mode, noise_name.split('.')[0], int(snr), FLAGS.corpus,
                                                  len(filelines_speech)))
            ...
            for i in range(len(filelines_speech)):
                ...
                print('{}/{}'.format(i, len(filelines_speech)))
